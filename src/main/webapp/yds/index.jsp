...
<%@ page import="com.xidu.service.DoLoginService"%>
	<%
       ...
       String name7 = uq.getQQ("room1.name7");
...
<header>
	...
	<nav class="sub">
		...
		<a href="javascript:;" class="forthwith"><img src="images/forthwith.gif"></a>
	</nav>
...
<div id="list">
	...
	<div class="listRight">
		...
		<ul class="nameLine">
			<li class="member current">在线会员(<%=SessionCounter.getOnline() %>)</li>
				...
				<div class="nano has-scrollbar">
				  	<div class="nano-content userlist" tabindex="0" style="right: -17px">
						<ul>
							<li>
								<span>天色倒影大海</span>
								<img src="images/list7.png">
							</li>
							<%
								LinkedList<HttpSession> sessionMap=SessionCounter.getSessionMap();
								for(HttpSession ss:sessionMap){
									Customer c=(Customer)ss.getAttribute("customer");
									if(c!=null){
									%>
										<li 
											<%
...
<div id="main">
	<div id="topic" style="height: 464px;">
		<div class="topicMain">
			...
			<div class="msg" id="bottomChats"><img src="images/msg.png"></div>
			<div class="qqbts">
				<span>在线客服：</span>
			    ...
			    <a href="tencent://message/?uin=<%=QQ7%>&Site=&menu=yes" target="_blank" class="qq_link_7"></a>
			</div> 
			<div id="topicinput">
...
<div class="plat hide">
	...
	<div class="platBox hide" id="platBox">
		<h3>川商所简介：</h3>
		<p>鑫至尊直播室作为川商所286号会员单位，能更好地为投资者提供专业的金融服务。四川川商商品交易中心有限公司是经四川省人民政府设立的创新型大宗商品交易服务平台，也是目前四川省唯一一家由省政府批复成立的交易平台。注册资本金1.2亿，依托于四川省西部经济中心的区位优势，以立足四川、辐射全国、放眼全球为发展目标，以“金融创新”为宗旨，为有色金属、矿产品以及农产品等商品提供现货交易及现货电子交易和相关商品的结算、交收、物流等方面的专业金融服务。</p>
...
<div class="login hide">
	<div class="logLeft">
		...
		<form action="#" method="post">
			...
			<input type="button" value="马上登录" class="mit" id="login">
		</form>
		<a href="javascript:;" class="close"></a>
	</div>
	<div class="logRight">
